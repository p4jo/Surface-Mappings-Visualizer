...
public abstract partial class Curve : ITransformable<Curve> // even IDrawnsformable in other part.
{
    ...
    protected virtual (float, ModelSurfaceBoundaryPoint)? FindIntersectionPointWithSideCloseTo(float t, ModelSurfaceSide side)
    {
        ...
        var intersectionTimesForwardThisSide = modelSurface.GeometrySurface.GetIntersectionOfGeodesics(geodesicForward, side);
        var intersectionTimesForwardOtherSide = modelSurface.GeometrySurface.GetIntersectionOfGeodesics(geodesicForward, side.other);
        ...
        var intersectionTimesBackwardThisSide = modelSurface.GeometrySurface.GetIntersectionOfGeodesics(geodesicBackward, side);
        var intersectionTimesBackwardOtherSide = modelSurface.GeometrySurface.GetIntersectionOfGeodesics(geodesicBackward, side.other);
